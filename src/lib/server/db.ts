...
function seedDatabase(database: Database.Database) {
  ...
  const tasks = [
    ...
    },
    {
      ...
      branchName: null,
      prUrl: null,
      githubUrl: "https://github.com/maxlee/project-agent-control-plane/issues/9",
    ...
    },
    {
      ...
      githubUrl: "https://github.com/maxlee/project-agent-control-plane/issues/7",
    ...
    },
    {
      ...
      branchName: null,
      prUrl: null,
      githubUrl: "https://github.com/maxlee/project-agent-control-plane/issues/15",
